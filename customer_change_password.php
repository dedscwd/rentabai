...
<html>
	<head>
		...
		<title>CHANGE PASSWORD | RENTABAI</title>
    </head>
	...
	<div class="backbody-home" >
		<div class="border-modal-login max-w-md w3-animate-top" >
			<div class="modalcon-login px-8 py-12 max-w-md mx-auto" style="height:400px;">
				<span class="w3-right buttonlogin-home w3-round"><a href="home.php"><button class="modal1-btn w3-right">&times;</button></a>
				</span>
					<h3>CHANGE PASSWORD</h3>
					<form action="actions/customer_change_password.php" method="POST">
						Current Password
