...
<html>
     <head>
		...
		<title>RENTOR REGISTRATION</title>
    </head>
			...
			<div class="regmodal-home">
				<div class="rentorform">
					<div class="rentorformsub1">
						<form action="actions/register_rentor.php" method="POST">
							<section class="rentorinputform1">
								<h3>RENTOR REGISTRATION</h3>
								...
								Firstname <br>
								<input required type="text" class="re-fname w3-input" name="firstname"/>
								Lastname
								<input required type="text" class="re-lname w3-input" name="lastname"/>
								Email
								<input required type="email" class="re-email w3-input" name="email"/>
								Username
								<input required type="text" class="re-uname w3-input" name="username"/>
								Password
								<input required type="password" class="re-pass w3-input"  name="password" minlength="8" maxlength="24" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"/>
								Re-enter Password
								<input required type="password" class="re-pass w3-input" name="password1" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"/>
								Age
								<input required type="text" class="re-age w3-input" name="age"/>
								Date of birth
								<input required type="date" class="re-date w3-input" name="dob"/>
								Phone Number
								<input required type="text" class="re-phone phonenumber w3-input" name="phone"/>
							</section>
					</div> 
					...
					<div class="rentorformsub2">
								<section class="rentorinputform2">
									...
									<h3>ADDRESS</h3>
									Postal Code
									<input required type="postalcode" class="w3-input" name="postal"/>
									<br>
									Province
									<input required type="province" class="w3-input" name="province"/>
									<br>
									City
									<input required type="city" class="w3-input" name="city"/>
									<br>
									Barangay
									<input required type="barangay" class="w3-input" name="barangay"/>
									<br>
									Street Name
									<input required type="streetname" class="w3-input" name="street"/><br><br><br>
									<input required class="w3-right rentor-reg" type="submit" name="submit" value="Register"/>
								</section>
					</div>
						</form>
				</div>
