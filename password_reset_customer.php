...
<!---THE ONE WHO CONTROLS THE NAVIGATION BAR--->
	...
	<!--RENTABAI LOGO-->  
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<a href="login_customer.php"><input type="button" style="border: 1px solid #18A0FB;" class="btn btn2-navhome" value="Login"/></a>
...
<!--START REGISTER AS-->
	<div class="backbody-home" >
		<div class="border-modal-login max-w-md w3-animate-top" >
			<div class="modalcon-login px-8 py-12 max-w-md mx-auto" style="height:300px;">
					...
					<div class="w3-center w3-text-green">
						<?php
							if(isset($_GET['email_sent'])){
								echo $_GET['email_sent'];
							}
						?>
					</div>
					<form action="actions/password_reset_customer_code.php" method="POST">
						Email Address
						<input class="w3-input" type="email" name="email"/>
						<br>
						<input class="w3-button w3-right w3-round w3-blue" type="submit" name="submit" value="Send Password Reset Link"/>
					</form>
					<br>
					<br>
