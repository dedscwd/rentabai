		...
		<table class="w3-table-all w3-centered w3-hoverable">
				<thead>
					<tr class="w3-light-gray">
						...
						<?php
						$sql = "SELECT COUNT(*) FROM tbl_product WHERE biketype='e-bike' and rentor_id = '$rentor_id' ORDER BY id";
				...
				<?php
					...
					$sql = "SELECT * FROM tbl_product WHERE biketype='e-bike' and rentor_id='$rentor_id' ORDER BY id";
					$result = mysqli_query($db, $sql);
