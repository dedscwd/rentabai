...
<!---THE ONE WHO CONTROLS THE NAVIGATION BAR--->
	...
	<!--RENTABAI LOGO-->  
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<a href="login_rentor.php"><input type="button" style="border: 1px solid #18A0FB;" class="btn btn2-navhome" value="Login"/></a>
		...
		<div class="border-modal-login max-w-md w3-animate-top" >
			<div class="modalcon-login px-8 py-12 max-w-md mx-auto" style="height:300px;">
				<span class="w3-right buttonlogin-home w3-round"><a href="index.php"><button class="modal1-btn">&times;</button></a>
					...
					<form action="actions/password_reset_code.php" method="POST">
						Email Address
