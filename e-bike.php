<?php
	...
	$limit = 10;  
	$sql = "select * from tbl_product WHERE biketype='E-Bike' ORDER BY id desc";    
	...
	$sql = "SELECT * FROM tbl_product WHERE biketype='E-Bike' LIMIT " . $initial_page . ',' . $limit;  
	$result = mysqli_query($db, $sql);
	...
	<!--SOCIAL MEDIA-->
				...
				<section class="rentdesc-home">
					...
					<ul class="desctext-footer">
						<li><a href="https://www.facebook.com/"><span class="footxt1">Communities</span></a></li>
