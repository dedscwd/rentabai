...
<!---THE ONE WHO CONTROLS THE NAVIGATION BAR--->
	...
	<div class="w3-dropdown-hover w3-right">
						...
						<a href="rentor_profile.php" class="w3-bar-item w3-button">Profile<a>
						<a href="reserved_order.php" class="w3-bar-item w3-button">Pending Products<a>
						<form action="actions/logout_rentor.php" method="POST">
							<input class="w3-button" type="submit"  name="logout" value="Logout"/>
						</form>
						</div>
					</div>
		</nav>
	...
	<div class="backbody-home" >
		<div class="border-modal-login max-w-md w3-animate-top" >
			<div class="modalcon-login px-8 py-12 max-w-md mx-auto" style="height:400px;">
				<span class="w3-right buttonlogin-home w3-round"><a href="rentor_shop.php"><button class="modal1-btn w3-right">&times;</button></a>
				</span>
					<h3>CHANGE PASSWORD</h3>
					<form action="actions/rentor_change_password.php" method="POST">
						Current Password
