	...
	<div class="backbody-home">
		<div class="border-modal-login max-w-md w3-animate-top">
			<div class="modalcon-login px-8 py-12 max-w-md mx-auto">
				<span class="w3-right buttonlogin-home"><a href="index.php"><button class="modal1-btn">&times;</button></a>
				</span>
					
					<h3>REGISTER AS</h3>
					<br><br>
					<a href="register_rentor.php"><input class="rentor-home w3-blue" type="button" value="Rentor"/></a>
					<br><br>
					<p class="regOR">or</p>
					<a href="register_customer.php"><input class="customer-home w3-blue" type="button" value="Customer"/></a>
					<br><br><br>
					<button class="backtohome-reg"><a href="index.php">Back to homepage</a></button>
					<br>
					<br>
